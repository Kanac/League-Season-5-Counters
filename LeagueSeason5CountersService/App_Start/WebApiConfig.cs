...
namespace LeagueSeason5CountersService
{
    public static class WebApiConfig
    {
        public static void Register()
        {
            ...
            //Database.SetInitializer(new LeagueSeason5CountersInitializer());
            var migrator = new DbMigrator(new Configuration());
            migrator.Update();
        }
    }

    public class LeagueSeason5CountersInitializer : DropCreateDatabaseAlways<LeagueSeason5CountersContext>
    {
